...
namespace StyleCop.Analyzers.SpacingRules
{
    ...
    internal class SA1016OpeningAttributeBracketsMustBeSpacedCorrectly : DiagnosticAnalyzerBase
    {
        /// <summary>
        ...
        private const string HelpLink = "https://github.com/bjornhellander/NewStyleCopAnalyzers/blob/master/documentation/SA1016.md";
        ...
        private static void HandleOpenBracketToken(SyntaxTreeAnalysisContext context, SyntaxToken token)
        {
            ...
            // Opening attribute brackets should not be followed by a space.
