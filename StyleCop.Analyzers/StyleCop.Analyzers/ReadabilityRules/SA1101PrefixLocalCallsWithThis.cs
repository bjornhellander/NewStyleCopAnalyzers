...
namespace StyleCop.Analyzers.ReadabilityRules
{
    ...
    internal class SA1101PrefixLocalCallsWithThis : DiagnosticAnalyzerBase
    {
        ...
        private const string HelpLink = "https://github.com/bjornhellander/NewStyleCopAnalyzers/blob/master/documentation/SA1101.md";
        ...
        private static void HandleSimpleName(SyntaxNodeAnalysisContext context)
        {
            ...
            case SyntaxKind.SimpleAssignmentExpression:
                if (((AssignmentExpressionSyntax)context.Node!.Parent).Left == context.Node) //// TODO: Try to get rid of !
                {
            ...
            case SyntaxKind.NameEquals:
                if (((NameEqualsSyntax)context.Node!.Parent).Name != context.Node) //// TODO: Try to get rid of !
                {
                    break;
                }
            ...
            for (; node != null; node = node.Parent)
            {
                ...
                case SyntaxKind.PropertyDeclaration:
                    ...
                    return !propertySyntax.Modifiers.Any(SyntaxKind.StaticKeyword)
                        ...
                        && !propertySyntax.Parent.IsKind(SyntaxKindEx.ExtensionBlockDeclaration);
                ...
                case SyntaxKind.MethodDeclaration:
                    ...
                    return !baseMethodSyntax.Modifiers.Any(SyntaxKind.StaticKeyword)
                        && !baseMethodSyntax.Parent.IsKind(SyntaxKindEx.ExtensionBlockDeclaration);
