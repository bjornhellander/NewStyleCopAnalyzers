...
namespace StyleCop.Analyzers.ReadabilityRules
{
    ...
    internal class SA1114ParameterListMustFollowDeclaration : DiagnosticAnalyzerBase
    {
        /// <summary>
        ...
        private const string HelpLink = "https://github.com/bjornhellander/NewStyleCopAnalyzers/blob/master/documentation/SA1114.md";
        ...
        private static void HandleWithElement(SyntaxNodeAnalysisContext context)
        {
            ...
            AnalyzeArgumentList(context, withElement.ArgumentList);
        }
