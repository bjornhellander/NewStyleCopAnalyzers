...
namespace StyleCop.Analyzers.ReadabilityRules
{
    ...
    internal class SA1106CodeMustNotContainEmptyStatements : DiagnosticAnalyzerBase
    {
        /// <summary>
        ...
        private static readonly DiagnosticDescriptor Descriptor =
            CreateDiagnosticDescriptor(DiagnosticId, Title, MessageFormat, AnalyzerCategory.ReadabilityRules, Description, customTags: new[] { WellKnownDiagnosticTags.Unnecessary });
