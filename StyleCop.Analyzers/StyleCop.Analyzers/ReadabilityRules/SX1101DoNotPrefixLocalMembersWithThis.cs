...
namespace StyleCop.Analyzers.ReadabilityRules
{
    ...
    internal class SX1101DoNotPrefixLocalMembersWithThis : DiagnosticAnalyzerBase
    {
        /// <summary>
        ...
        private static readonly DiagnosticDescriptor Descriptor =
            CreateDiagnosticDescriptor(DiagnosticId, Title, MessageFormat, AnalyzerCategory.ReadabilityRules, Description, isEnabledByDefault: false, customTags: new[] { WellKnownDiagnosticTags.Unnecessary });
