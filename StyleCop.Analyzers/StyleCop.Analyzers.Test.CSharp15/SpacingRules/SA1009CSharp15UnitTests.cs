...
namespace StyleCop.Analyzers.Test.CSharp15.SpacingRules
{
    ...
    public partial class SA1009CSharp15UnitTests : SA1009CSharp14UnitTests
    {
        [Fact]
        public async Task TestCollectionExpressionWithElementSpaceBeforeClosingParenthesisAsync()
        {
            var testCode = @"
...
public class Foo
{
    public void Bar()
    {
        List<string> names = [with(capacity: 10 {|#0:)|}, ""a""];
    }
}";
