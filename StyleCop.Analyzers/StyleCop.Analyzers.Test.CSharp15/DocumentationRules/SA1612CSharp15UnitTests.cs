...
namespace StyleCop.Analyzers.Test.CSharp15.DocumentationRules
{
    ...
    public partial class SA1612CSharp15UnitTests
    {
        [Fact]
...
";
            ...
            var expected = new[]
            {
                Diagnostic().WithMessageFormat("The parameter documentation for '{0}' should be at position {1}").WithLocation(0).WithArguments("second", "2"),
                Diagnostic().WithMessageFormat("The parameter documentation for '{0}' should be at position {1}").WithLocation(1).WithArguments("first", "1"),
            };
